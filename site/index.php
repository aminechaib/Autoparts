...
<body>
				...
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						<div class="hero-text-tablecell">
							<p class="subtitle">Qualité et Prix</p>
							<h1>Pieces de rechange de haute qualité</h1>
							<div class="hero-btns">
								<a href="shop.php" class="boxed-btn">Pieces Collection</a>
	...
	<div class="product-section mt-150 mb-150">
		<div class="container">
			...
			<?php
$sql="SELECT `id`, `name`, `id_ad`, `creation_date` FROM `category`";
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						...
						<h2>We are <span class="orange-text">Auto Parts</span></h2>
