         ...
         <div class="ui padded grid">
             ...
             <div class="ui fifteen wide column row centered grid segment">
                 ...
                 <div class="ui pointing secondary big menu">
                     ...
                     <h1 class="ui  header item"><i class="facebook messenger icon"></i>Contacts</h1>
                             ...
                             <?php
                                ...
                                ?>
                                     <tr>
                                         ...
                                         <td>
                                         <a href="afficher.php?msg_id=<?php echo $msg->id; ?>" class="ui tiny blue button">afficher</a>

                                         <td>
                                             <button class="ui tiny red button" data-button_id="<?php echo h($msg->id) ?>" data-type="supprimer">
