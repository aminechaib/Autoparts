...
?>
        ...
        <div class="ui fluid container">
            ...
            <h1>Modifier le moteur N° <?php echo $id ?></h1>
                ...
                <div class="ui fifteen wide column row centered grid" id="modifier_grid<?php echo $id ?>">
                    ...
                    <form method="POST" class="ui form" id="modifier_form<?php echo $id ?>" action="update_moteur.php?id=<?php echo $id ?>">
                        <div class="two fields">
                            <div class="field">
                                <label>Nom</label>
                                <input type="text" name="name" placeholder="Nom de moteur">
                            </div>
                            <div class="field">
                            ...
                            <label>puissance</label>
                                <input type="number"  name="puissance" placeholder="Puissance de moteur">
                            </div>
                        </div>
